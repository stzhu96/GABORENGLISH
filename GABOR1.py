...
def parse_contents(contents):
    ...
    return html.Div([
        ...
        html.P(f"Gabor B\G\R mean: {mean_row[0]:.2f}, {mean_row[1]:.2f}, {mean_row[2]:.2f}"),
        html.P(f"Gabor B\G\R standard deviation: {stddev_row[0]:.2f}, {stddev_row[1]:.2f}, {stddev_row[2]:.2f}")
    ])
